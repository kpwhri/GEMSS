  ...
  createDb() {
    const journalEntries: JournalEntry[] = [
      ...
      { id: 2, title: 'Just some thoughts',
        entry: "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
        created: new Date(), updated: new Date() },
      { id: 3, title: 'Ups and downs',
        entry: "Purus sit amet volutpat consequat. Ornare arcu dui vivamus arcu felis bibendum ut. Vel quam elementum pulvinar etiam non quam lacus suspendisse faucibus.",
        created: new Date(), updated: new Date() }
    ];
